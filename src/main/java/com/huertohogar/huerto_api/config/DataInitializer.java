...
public class DataInitializer implements CommandLineRunner {
    ...
    private void crearTablaMensajeContacto() {
        jdbcTemplate.execute("""
                CREATE TABLE MENSAJE_CONTACTO (
                    ...
                    CONSTRAINT PK_MENSAJE_CONTACTO PRIMARY KEY (ID)
                )
                """);
    }
    ...
    private void poblarBlogs() {
        String contenido1 = """
                [
                  ...
                  "Usa recipientes con buen drenaje para evitar encharcamientos.",
                  "Riega en los horarios de menor calor para aprovechar mejor el agua.",
                  "Observa tus plantas a diario para detectar plagas o falta de nutrientes a tiempo."
                ]
                """;

        String contenido2 = """
                [
                  "Prefiere plantas nativas o adaptadas a tu clima para reducir el consumo de agua.",
                  "Reduce al máximo el uso de químicos y fertilizantes sintéticos.",
                  "Reutiliza el agua de lluvia o de enjuague de verduras para el riego.",
                  "Crea tu propio compost con restos de frutas y verduras para mejorar el suelo."
                ]
                """;
    ...
    // -------------------------------------------------------------------------
    // POBLAR MENSAJES DE CONTACTO (DEMO)
    // -------------------------------------------------------------------------
    private void poblarMensajesContacto() {
        jdbcTemplate.update("""
                INSERT INTO MENSAJE_CONTACTO (NOMBRE, CORREO, ASUNTO, MENSAJE)
                VALUES (
                    'Cliente Demo',
                    'cliente.demo@correo.cl',
                    'Consulta inicial',
                    'Hola, este es un mensaje de prueba para verificar el módulo de contacto en Huerto Hogar.'
                )
                """);
    }
}
